...
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "dbfs:/Volumes/tthdatabricksdev/dev/bronze/hosa/encounters"
# MAGIC );
# MAGIC
# MAGIC CREATE OR REPLACE TEMP VIEW hosb_encounters
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "dbfs:/Volumes/tthdatabricksdev/dev/bronze/hosb/encounters"
# MAGIC );
# MAGIC
...
dbutils.fs.ls("dbfs:/Volumes/tthdatabricksdev/dev/bronze/")

# COMMAND ----------

# MAGIC %sql SHOW VOLUMES IN tthdatabricksdev.dev

# COMMAND ----------

def check_and_list(path):
    try:
...
check_and_list("dbfs:/Volumes/tthdatabricksdev/dev/bronze/hosa/encounters")
check_and_list("dbfs:/Volumes/tthdatabricksdev/dev/bronze/hosb/encounters")
