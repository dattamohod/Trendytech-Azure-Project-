...
df_hosa=spark.read.parquet("/Volumes/tthdatabricksdev/dev/bronze/hosa/patients")
df_hosa.createOrReplaceTempView("patients_hosa")

#Reading Hospital B patient data 
df_hosb=spark.read.parquet("/Volumes/tthdatabricksdev/dev/bronze/hosb/patients")
