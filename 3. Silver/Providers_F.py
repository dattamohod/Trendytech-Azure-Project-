...
df_hosa=spark.read.parquet("/Volumes/tthdatabricksdev/dev/bronze/hosa/providers")

#Reading Hospital B departments data 
df_hosb=spark.read.parquet("/Volumes/tthdatabricksdev/dev/bronze/hosb/providers")
