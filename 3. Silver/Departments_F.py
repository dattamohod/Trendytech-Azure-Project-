...
df_hosa=spark.read.parquet("/Volumes/tthdatabricksdev/dev/bronze/hosa/departments")

#Reading Hospital B departments data 
df_hosb=spark.read.parquet("/Volumes/tthdatabricksdev/dev/bronze/hosb/departments")
