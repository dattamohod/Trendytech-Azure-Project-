...
# Read the CSV file
cptcodes_df = spark.read.csv("/Volumes/tthdatabricksdev/dev/landing/cptcodes/*.csv", header=True)
...
cptcodes_df.write.format("parquet").mode("overwrite").save("/Volumes/tthdatabricksdev/dev/bronze/cpt_codes")
