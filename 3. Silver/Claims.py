...
claims_df=spark.read.csv("/Volumes/tthdatabricksdev/dev/landing/claims/*.csv",header=True)
...
claims_df.write.format("parquet").mode("overwrite").save("/Volumes/tthdatabricksdev/dev/bronze/claims/")
